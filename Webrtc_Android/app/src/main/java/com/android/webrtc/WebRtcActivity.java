...
public class WebRtcActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIsCaller = getIntent().getBooleanExtra(KEY_CALLER,true);
        ...
        if(!mIsCaller){
            String oldCallerName = tvFromName.getText().toString();
            String oldCallerFrom = tvFrom.getText().toString();

            String oldCalledName = tvToNname.getText().toString();
            String oldCalledTo = tvTo.getText().toString();

            tvFromName.setText(oldCalledName);
            tvFrom.setText(oldCalledTo);

            tvToNname.setText(oldCallerName);
            tvTo.setText(oldCallerFrom);
        }
    ...
    private void connectionWebsocket() {
        String serverUrl = SharePreferences.getInstance(WebRtcActivity.this).getServerUrl();
        Log.d(TAG,"connectionWebsocket serverUrl:" + serverUrl);
        try {
